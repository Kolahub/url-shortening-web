...
function setShims(shims, options = { auto: false }) {
    if (exports.auto) {
        throw new Error(`you must \`import 'dub/shims/${shims.kind}'\` before importing anything else from dub`);
    }
    if (exports.kind) {
        throw new Error(`can't \`import 'dub/shims/${shims.kind}'\` after \`import 'dub/shims/${exports.kind}'\``);
    }
